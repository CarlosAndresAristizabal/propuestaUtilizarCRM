  ...
  $(".goal_real_estate").click(function () {
    ...
    $("body")
      .fadeTo("ease", 0.3, function () {
        $(this).css(
          "background-image",
          "url(http://extrawall.net/images/wallpapers/378_1920x1080_abstract_city.jpg)"
        );
      })
      .fadeTo("slow", 1);
  });
  ...
  $(".goal_retirement").click(function () {
    ...
    $("body")
      .fadeTo("ease", 0.3, function () {
        $(this).css(
          "background-image",
          "url(https://wallpaperscraft.com/image/tropics_sea_palm_trees_vacation_84858_2412x1810.jpg)"
        );
      })
      .fadeTo("slow", 1);
  });
  ...
  $(".goal_involve").click(function () {
    ...
    $("body")
      .fadeTo("ease", 0.3, function () {
        $(this).css(
          "background-image",
          "url(http://www.churchmilitant.com/images/uploads/2015-06-12-niles-x.jpg)"
        );
      })
      .fadeTo("slow", 1);
  });
